   ...
   // Map applicationdetailsdata = json.decode(data);
    ...
    for (var items in videos){ //iterate over the list
         ...
         // txtbusiness_process_name.text=myMap['business_process_name'];
          ...
          _txtclientnameString =  'Applicant Name: ' + myMap['client_name'].toString();
          _txtbusiness_process_nameString =  'Service Type: ' + myMap['business_process_name'].toString();
         _txtjob_statusString = 'Application Status: ' + myMap['job_status'].toString();
        });
     ...
     backgroundColor: Theme.of(context).primaryColor,
      appBar: new AppBar(
        ...
        leading: IconButton(
          ...
          icon: Icon(Icons.arrow_back_ios_outlined, size: 18, color:Colors.white),
        ),
      ),
