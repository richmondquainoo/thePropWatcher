    ...
    return Scaffold(
      ...
      persistentFooterButtons: [
        Column(
          children: [
            Text(
              "Please confirm the red polygon on the map matches the exact boundaries of the plot of interest. Once satisfied, please press the button below to continue",
              ...
              child: TextButtonComponent(
                ...
                onTap: () {
                  new UtilityService().confirmationBox(
                      title: 'Confirm Boundary Verification',
                      ...
                      onYes: () {
                        ...
                        UserProfileModel user =
                            Provider.of<AppData>(context, listen: false)
                                .userData;
                        VerifySiteRequestModel requestModel =
                        ...
                        getServiceCharge(
                          serviceCode: 'VSL',
                          context: context,
                          requestObject: jsonEncode(requestModel),
                        );
                      },
                      onNo: () {
                        Navigator.pop(context);
